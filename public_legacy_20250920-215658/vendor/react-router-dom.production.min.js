...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ? t(exports, require("react"), require("history"), require("react-router"))
  ...
  const c = t.forwardRef(function (e, r) {
      let {
          onClick: i,
          reloadDocument: c,
          replace: s = !1,
        ...
        d = o(e, u),
        m = n.useHref(y),
        p = l(y, { replace: s, state: f, target: b });
      return t.createElement(
        "a",
        a({}, d, {
          href: m,
          onClick: function (e) {
            (i && i(e), e.defaultPrevented || c || p(e));
          },
          ref: r,
          target: b,
        }),
    ...
    s = t.forwardRef(function (e, r) {
      let {
        ...
        m = o(e, i),
        p = n.useLocation(),
        g = n.useResolvedPath(y),
        h = p.pathname,
        P = g.pathname;
      s || ((h = h.toLowerCase()), (P = P.toLowerCase()));
      let O,
        v = h === P || (!f && h.startsWith(P) && "/" === h.charAt(P.length)),
        R = v ? u : void 0;
      O =
        "function" == typeof l
          ? l({ isActive: v })
      ...
      return t.createElement(
        c,
        a({}, m, { "aria-current": R, className: O, ref: r, style: j, to: y }),
        "function" == typeof d ? d({ isActive: v }) : d,
      );
    });
  function l(e, r) {
    let { target: a, replace: o, state: u } = void 0 === r ? {} : r,
      i = n.useNavigate(),
      c = n.useLocation(),
      s = n.useResolvedPath(e);
    return t.useCallback(
      (t) => {
        if (
          ...
          t.preventDefault();
          let r = !!o || n.createPath(c) === n.createPath(s);
          i(e, { replace: r, state: u });
        }
      },
      [c, i, s, o, u, a, e],
    );
  ...
  (Object.defineProperty(e, "MemoryRouter", {
    ...
    (e.BrowserRouter = function (e) {
      let { basename: a, children: o, window: u } = e,
        i = t.useRef();
      null == i.current && (i.current = r.createBrowserHistory({ window: u }));
      let c = i.current,
        [s, l] = t.useState({ action: c.action, location: c.location });
      return (
        t.useLayoutEffect(() => c.listen(l), [c]),
        t.createElement(n.Router, {
          basename: a,
          children: o,
          location: s.location,
    ...
    (e.HashRouter = function (e) {
      let { basename: a, children: o, window: u } = e,
        i = t.useRef();
      null == i.current && (i.current = r.createHashHistory({ window: u }));
      let c = i.current,
        [s, l] = t.useState({ action: c.action, location: c.location });
      return (
        t.useLayoutEffect(() => c.listen(l), [c]),
    ...
    (e.unstable_HistoryRouter = function (e) {
      let { basename: r, children: a, history: o } = e;
      const [u, i] = t.useState({ action: o.action, location: o.location });
      return (
        t.useLayoutEffect(() => o.listen(i), [o]),
        t.createElement(n.Router, {
          basename: r,
          children: a,
          location: u.location,
    ...
    (e.useSearchParams = function (e) {
      let r = t.useRef(f(e)),
        ...
        o = t.useMemo(() => {
          let e = f(a.search);
          for (let t of r.current.keys())
            e.has(t) ||
              r.current.getAll(t).forEach((r) => {
                e.append(t, r);
              });
          return e;
        }, [a.search]),
