...
declare module '@contracts/prescriptions' {
    ...
    export type PrescriptionRecord = import('../../../contracts/src/prescriptions').PrescriptionRecord;
    export type PrescriptionCreateInput = import('../../../contracts/src/prescriptions').PrescriptionCreateInput;
}
